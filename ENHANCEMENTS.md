...
**Current Version:** 2.1 (Refined Edition)
**Date:** 2026-05-18
**Major Changes:**
- Fixed "burned-in" mojibake encoding issues across all 23 chapters.
- Audited and corrected all "Chapter N" cross-references to match Quarto-rendered numbering.
- Updated Preface (index.qmd) and Summary (summary.qmd) to reflect the 23-chapter structure.
- Added comprehensive Exercise sections to 5 key chapters for improved pedagogical value.
- Refined case study descriptions and structural consistency.

**Previous Version:** 2.0 (Enhanced Edition)
**Date:** 2024
**Major Changes:**
